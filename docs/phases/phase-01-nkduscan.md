...
- [ ] USB-to-SCSI wrapping protocol documented byte-by-byte in `docs/kb/architecture/usb-protocol.md`
...
- [ ] All KB docs in `docs/kb/components/nkduscan/` written with status >= "In Progress"
...
**Output**: `docs/kb/components/nkduscan/api.md` with export/import list
...
**Output**: Class hierarchy diagram, vtable mapping in `docs/kb/components/nkduscan/classes.md`
...
**Output**: Complete function code table in `docs/kb/components/nkduscan/api.md`
...
**Output**: Byte-level protocol documentation in `docs/kb/architecture/usb-protocol.md`
...
**Output**: IOCTL mapping table in `docs/kb/components/nkduscan/usb-transport.md`
...
**Output**: Session lifecycle documentation in `docs/kb/components/nkduscan/overview.md`
...
## KB Deliverables
- `docs/kb/components/nkduscan/overview.md`
- `docs/kb/components/nkduscan/classes.md`
- `docs/kb/components/nkduscan/api.md`
- `docs/kb/components/nkduscan/usb-transport.md`
- `docs/kb/architecture/usb-protocol.md`

## Log Files
- Phase log: `docs/log/phases/phase-01-nkduscan.md`
- Component logs: `docs/log/components/nkduscan-attempts.md`, `docs/log/components/nkdsbp2-attempts.md`
