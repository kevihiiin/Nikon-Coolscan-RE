...
**Output**: Annotated startup sequence in `kb/components/firmware/startup.md`
...
**Output**: Vector table map in `kb/components/firmware/vector-table.md`
...
**Output**: USB controller interface docs in `kb/components/firmware/isp1581-usb.md`
...
**Output**: Command dispatch table in `kb/components/firmware/scsi-handler.md`
...
**Output**: Per-handler analysis in `kb/scsi-commands/` (cross-referencing host-side docs from Phase 2)
...
**Output**: Motor control docs in `kb/components/firmware/motor-control.md`
...
**Output**: Table documentation in relevant `kb/components/firmware/` subdocs
...
**Where to look**: Compare Phase 2 `kb/scsi-commands/` with firmware handler analysis
...
- `kb/architecture/usb-protocol.md` (Phase 1)
- `kb/scsi-commands/` (Phase 2)
- `kb/reference/memory-map.md` (Phase 0)
- H8/300H instruction set reference
- ISP1581 datasheet

## KB Deliverables
- `kb/components/firmware/startup.md`
- `kb/components/firmware/vector-table.md`
- `kb/components/firmware/isp1581-usb.md`
- `kb/components/firmware/scsi-handler.md`
- `kb/components/firmware/motor-control.md`
- Update `kb/scsi-commands/` with firmware-side verification
- Update confidence levels to "Verified" for cross-validated commands

## Log Files
- Phase log: `logs/phases/phase-04-firmware.md`
- Component log: `logs/components/firmware-attempts.md`
